...
const BulkActionsToolbar: React.FC<BulkActionsToolbarProps> = ({
  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 flex flex-col items-center sm:flex-row sm:justify-between gap-4">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-2 w-full sm:w-auto">
        <span className="text-sm text-slate-600 mr-2">Acciones en lote:</span>
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-1.5 text-sm border-slate-300 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white"
            defaultValue=""
          ...
          <div className="flex items-center rounded-md border border-slate-300 bg-white">
            <button onClick={() => onSetPastorStatus(true)} className="px-3 py-1.5 text-sm hover:bg-slate-50 rounded-l-md">Marcar Pastor</button>
            <button onClick={() => onSetPastorStatus(false)} className="px-3 py-1.5 text-sm hover:bg-slate-50 rounded-r-md border-l border-slate-300">Quitar Pastor</button>
          </div>
          <button
            onClick={onDelete}
